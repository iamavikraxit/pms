...
<aside id="pmsSidebar"
        ...
        <a href="{{ route('dashboard') }}" class="flex items-center gap-3.5 group">
            ...
            <div class="flex flex-col">
                <div class="flex items-center gap-1.5">
                    <span class="text-[9px] font-black uppercase tracking-[0.3em] text-stone-400 leading-none">Photo Booking</span>
                </div>
                <span class="text-lg font-black tracking-tight text-stone-900 leading-none mt-1">
    ...
    <nav class="flex-1 overflow-y-auto p-4 space-y-6 custom-scrollbar">
        ...
        <div>
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('dashboard') }}"
                    class="group flex items-center gap-3.5 rounded-2xl bg-gradient-to-r from-orange-500 to-red-500 px-4 py-3 text-sm font-bold text-white shadow-lg shadow-orange-500/25 transition-all duration-300">
                ...
                <div>
                    <button id="rolesDropdownBtn" onclick="toggleDropdown('rolesDropdown')"
                        ...
                        <div class="flex items-center gap-3.5">
                            <svg class="h-5 w-5 text-stone-400 group-hover:text-orange-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                    d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                            </svg>
                            <span>Roles & Permissions</span>
                        </div>
                        <svg id="rolesDropdownArrow" class="w-4 h-4 text-stone-400 group-hover:text-orange-600 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <div id="rolesDropdownMenu" style="max-height: 0px;" class="overflow-hidden transition-all duration-300 ease-in-out pl-12 pr-4 space-y-1">
                        <a href="#" class="flex items-center gap-2 text-xs font-bold text-stone-500 hover:text-orange-600 py-2 transition-colors">
            ...
            <div class="space-y-1">
                ...
                <div>
                    <button id="projectsDropdownBtn" onclick="toggleDropdown('projectsDropdown')"
                        ...
                        <svg id="projectsDropdownArrow" class="w-4 h-4 text-stone-400 group-hover:text-orange-600 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <div id="projectsDropdownMenu" style="max-height: 0px;" class="overflow-hidden transition-all duration-300 ease-in-out pl-12 pr-4 space-y-1">
                        <a href="#" class="flex items-center gap-2 text-xs font-bold text-stone-500 hover:text-orange-600 py-2 transition-colors">
                            <span class="h-1.5 w-1.5 rounded-full bg-stone-300 group-hover:bg-orange-500"></span>
                            Active Projects
                        </a>
                    ...
                    <button id="bookingsDropdownBtn" onclick="toggleDropdown('bookingsDropdown')"
                        ...
                        <div class="flex items-center gap-3.5">
                            <svg class="h-5 w-5 text-stone-400 group-hover:text-orange-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <path stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" />
                            </svg>
                            <span>Bookings & Shoots</span>
                        </div>
                        <svg id="bookingsDropdownArrow" class="w-4 h-4 text-stone-400 group-hover:text-orange-600 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <div id="bookingsDropdownMenu" style="max-height: 0px;" class="overflow-hidden transition-all duration-300 ease-in-out pl-12 pr-4 space-y-1">
                        <a href="#" class="flex items-center gap-2 text-xs font-bold text-stone-500 hover:text-orange-600 py-2 transition-colors">
                            <span class="h-1.5 w-1.5 rounded-full bg-stone-300 group-hover:bg-orange-500"></span>
                            Upcoming Shoots
                        </a>
            ...
            <div class="space-y-1">
                ...
                <div>
                    <button id="mediaDropdownBtn" onclick="toggleDropdown('mediaDropdown')"
                        ...
                        <svg id="mediaDropdownArrow" class="w-4 h-4 text-stone-400 group-hover:text-orange-600 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <div id="mediaDropdownMenu" style="max-height: 0px;" class="overflow-hidden transition-all duration-300 ease-in-out pl-12 pr-4 space-y-1">
                        <a href="#" class="flex items-center gap-2 text-xs font-bold text-stone-500 hover:text-orange-600 py-2 transition-colors">
                            <span class="h-1.5 w-1.5 rounded-full bg-stone-300 group-hover:bg-orange-500"></span>
                            Client Galleries
                        </a>
                ...
                <div>
                    <button id="crmDropdownBtn" onclick="toggleDropdown('crmDropdown')"
                        ...
                        <svg id="crmDropdownArrow" class="w-4 h-4 text-stone-400 group-hover:text-orange-600 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <div id="crmDropdownMenu" style="max-height: 0px;" class="overflow-hidden transition-all duration-300 ease-in-out pl-12 pr-4 space-y-1">
                        <a href="#" class="flex items-center gap-2 text-xs font-bold text-stone-500 hover:text-orange-600 py-2 transition-colors">
                            <span class="h-1.5 w-1.5 rounded-full bg-stone-300 group-hover:bg-orange-500"></span>
                            Client Directory
                        </a>
        ...
        <!-- 4. FINANCE & SETTINGS -->
        <div>
            <p class="px-4 text-[9px] font-black uppercase tracking-[0.25em] text-stone-400 mb-3">Finance & Administration</p>
            <div class="space-y-1">
                ...
                <div>
                    <button id="financeDropdownBtn" onclick="toggleDropdown('financeDropdown')"
                        ...
                        <svg id="financeDropdownArrow" class="w-4 h-4 text-stone-400 group-hover:text-orange-600 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <div id="financeDropdownMenu" style="max-height: 0px;" class="overflow-hidden transition-all duration-300 ease-in-out pl-12 pr-4 space-y-1">
                        <a href="#" class="flex items-center gap-2 text-xs font-bold text-stone-500 hover:text-orange-600 py-2 transition-colors">
                            <span class="h-1.5 w-1.5 rounded-full bg-stone-300 group-hover:bg-orange-500"></span>
                            Invoices List
                        </a>
                ...
                <div>
                    <button id="settingsDropdownBtn" onclick="toggleDropdown('settingsDropdown')"
                        ...
                        <svg id="settingsDropdownArrow" class="w-4 h-4 text-stone-400 group-hover:text-orange-600 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <div id="settingsDropdownMenu" style="max-height: 0px;" class="overflow-hidden transition-all duration-300 ease-in-out pl-12 pr-4 space-y-1">
                        <a href="#" class="flex items-center gap-2 text-xs font-bold text-stone-500 hover:text-orange-600 py-2 transition-colors">
                            <span class="h-1.5 w-1.5 rounded-full bg-stone-300 group-hover:bg-orange-500"></span>
                            General Profile
                        </a>
